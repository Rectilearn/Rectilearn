...
<header>
	<a class="nav-title" href="/dashboard">Rectilearn</a>
		...
		<div class="flex gap-4 md:gap-9 font-semibold">
			...
			<div class="flex justify-center items-center">
				<button
					...
					on:click={() => (isUserProfileModalOpen = true)}
				>
					<img class="size-8 object-cover" src="/avatars/avatar_b.png" alt="avatar b" />
					...
					<div>
						<svg
							...
							height="1em"
							width="1em"
							xmlns="http://www.w3.org/2000/svg"><polyline points="6 9 12 15 18 9"></polyline></svg
						>
					</div>
				</button>
			</div>
