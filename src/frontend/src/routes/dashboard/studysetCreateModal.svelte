	...
	<Form bind:errorMessages on:submit={createStudySet}>
		...
		<section class="w-full">
			<ul class="flex mb-6 w-full">
				<li class="w-full"><button type="button" class="w-full h-full p-2 focus-border" on:click={() => tabIndex = 0}>Start</button></li>
				<li class="w-full"><button type="button" class="w-full h-full p-2 focus-border" on:click={() => tabIndex = 1}>Import</button></li>
				<li class="w-full"><button type="button" class="w-full h-full p-2 focus-border" on:click={() => tabIndex = 2}>Create</button></li>
			</ul>
			{#if tabIndex === 0}
				<div>
					<button type="button" class="w-full bg-[#3182ce] mb-2 text-white py-2 rounded-md font-medium" on:click={() => tabIndex = 1}>Import set from quizlet</button>
					<button type="button" class="w-full bg-[#3182ce] text-white py-2 rounded-md font-medium" on:click={() => tabIndex = 2}>Create a set yourself</button>
				</div>
			{:else if tabIndex === 1}
				<div>
					...
					<textarea
						placeholder="exported study set"
